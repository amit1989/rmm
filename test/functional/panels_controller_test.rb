...
class PanelsControllerTest < ActionController::TestCase
  ...
  test "should create panel" do
    assert_difference('Panel.count') do
      post :create, panel: { contactno: @panel.contactno, designation: @panel.designation, detail: @panel.detail, email: @panel.email, membershipno: @panel.membershipno, name: @panel.name }
    end
  ...
  test "should update panel" do
    put :update, id: @panel, panel: { contactno: @panel.contactno, designation: @panel.designation, detail: @panel.detail, email: @panel.email, membershipno: @panel.membershipno, name: @panel.name }
    assert_redirected_to panel_path(assigns(:panel))
  end
